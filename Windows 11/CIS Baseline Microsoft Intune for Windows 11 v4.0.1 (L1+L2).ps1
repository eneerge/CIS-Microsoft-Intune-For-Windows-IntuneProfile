...
$params = @{
  ...
  omaSettings = @(
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.20.1.3 (L2) Ensure 'Turn off Help Experience Improvement Program' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.20.1.4 (L2) Ensure 'Turn off Internet Connection Wizard if URL connection is referring to Microsoft.com' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.20.1.5 (L1) Ensure 'Turn off Internet download for Web publishing and online ordering wizards' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.20.1.11 (L2) Ensure 'Turn off the Windows Messenger Customer Experience Improvement Program' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.24.1 (L2) Ensure 'Disallow copying of user input methods to the system account for sign-in' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.28.5.1 (L1) Ensure 'Allow network connectivity during connected-standby (on battery)' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.28.5.2 (L1) Ensure 'Allow network connectivity during connected-standby (plugged in)' is set to 'Disabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.28.5.3 (BL) Ensure 'Allow standby states (S1-S3) when sleeping (on battery)' is set to 'Disabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.28.5.4 (BL) Ensure 'Allow standby states (S1-S3) when sleeping (plugged in)' is set to 'Disabled'"
        "description" = "Opposed"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.38.5.1 (L2) Ensure 'Microsoft Support Diagnostic Tool: Turn on MSDT interactive communication with support provider' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.3.2 (L2) Ensure 'Block launching Universal Windows apps with Windows Runtime API access from hosted content.' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.5.1 (L1) Ensure 'Do not preserve zone information in file attachments' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.8.2(L1) Ensure 'Enumerate administrator accounts on elevation' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.20.1 (L1) Ensure 'Prevent the computer from joining a homegroup' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.31.1 (L1) Ensure 'Prevent users from sharing files within their profile.' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.36.4.2.1 (L2) Ensure 'Allow users to connect remotely by using Remote Desktop Services' is set to 'Disabled'"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.36.4.9.3 (L1) Ensure 'Require use of specific security layer for remote (RDP) connections' is set to 'Enabled: SSL'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.36.4.9.4 (L1) Ensure 'Require user authentication for remote connections by using Network Level Authentication' is set to 'Enabled'"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "3.11.36.4.10.1 (L2) Ensure 'Set time limit for active but idle Remote Desktop Services sessions' is set to 'Enabled: 15 minutes or less, but not Never (0)'"
          "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.4.1 (L1) Ensure 'Apply UAC restrictions to local accounts on network logons' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.4.2 (L1) Ensure 'Configure SMB v1 client driver' is set to 'Enabled: Disable driver (recommended)'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.4.3 (L1) Ensure 'Configure SMB v1 server' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.4.4 (L1) Ensure 'Enable Structured Exception Handling Overwrite Protection (SEHOP)' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.4.5 (L1) Ensure 'WDigest Authentication' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.1 (L1) Ensure 'MSS: (AutoAdminLogon) Enable Automatic Logon (not recommended)' is set to 'Disabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.2 (L1) Ensure 'MSS: (DisableIPSourceRouting IPv6) IP source routing protection level (protects against packet spoofing)' is set to 'Enabled: Highest protection, source routing is completely disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.3 (L1) Ensure 'MSS: (DisableIPSourceRouting) IP source routing protection level (protects against packet spoofing)' is set to 'Enabled: Highest protection, source routing is completely disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.4 (L2) Ensure 'MSS: (DisableSavePassword) Prevent the dial-up password from being saved' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.5 (L1) Ensure 'MSS: (EnableICMPRedirect) Allow ICMP redirects to override OSPF generated routes' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.6 (L2) Ensure 'MSS: (KeepAliveTime) How often keep-alive packets are sent in milliseconds' is set to 'Enabled: 300,000 or 5 minutes (recommended)'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.7 (L1) Ensure 'MSS: (NoNameReleaseOnDemand) Allow the computer to ignore NetBIOS name release requests except from WINS servers' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.8 (L2) Ensure 'MSS: (PerformRouterDiscovery) Allow IRDP to detect and configure Default Gateway addresses (could lead to DoS)' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.9 (L1) Ensure 'MSS: (SafeDllSearchMode) Enable Safe DLL search mode (recommended)' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.10 (L1) Ensure 'MSS: (ScreenSaverGracePeriod) The time in seconds before the screen saver grace period expires (0 recommended)' is set to 'Enabled: 5 or fewer seconds'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.11 (L2) Ensure 'MSS: (TcpMaxDataRetransmissions IPv6) How many times unacknowledged data is retransmitted' is set to 'Enabled: 3'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.12 (L2) Ensure 'MSS: (TcpMaxDataRetransmissions) How many times unacknowledged data is retransmitted' is set to 'Enabled: 3'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.5.13 (L1) Ensure 'MSS: (WarningLevel) Percentage threshold for the security event log at which the system will generate a warning' is set to 'Enabled: 90% or less'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.4.1 (L1) Ensure 'Turn off multicast name resolution' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.8.1 (L2) Ensure 'Turn on Mapper I/O (LLTDIO) driver' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.8.2 (L2) Ensure 'Turn on Responder (RSPNDR) driver' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.9.1 (L1) Ensure 'Prohibit installation and configuration of Network Bridge on your DNS domain network' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.9.2 (L1) Ensure 'Prohibit use of Internet Connection Sharing on your DNS domain network' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.9.3 (L1) Ensure 'Require domain users to elevate when setting a network's location' is set to 'Enabled'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.17.1 (L2) Ensure 'Configuration of wireless settings using Windows Connect Now' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.17.2 (L2) Ensure 'Prohibit access of the Windows Connect Now wizards' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.18.1 (L1) Ensure 'Minimize the number of simultaneous connections to the Internet or a Windows Domain' is set to 'Enabled: 3 = Prevent Wi-Fi when on Ethernet'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.6.18.2 (L1) Ensure 'Prohibit connection to non-domain networks when connected to domain authenticated network' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.7.1 (L1) Ensure 'Allow Print Spooler to accept client connections' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "4.9.1.1 (L1) Ensure 'Turn off toast notifications on the lock screen' is set to 'Blocked'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.4.1 (L1) Ensure 'Include command line in process creation events' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.5.1 (L1) Ensure 'Encryption Oracle Remediation' is set to 'Enabled: Force Updated Clients'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.5.2 (L1) Ensure 'Remote host allows delegation of non-exportable credentials' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.13.1 (L1) Ensure 'Boot-Start Driver Initialization Policy' is set to 'Enabled: Good, unknown and bad but critical'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.19.1 (L1) Ensure 'Continue experiences on this device' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.19.2 (L1) Ensure 'Turn off background refresh of Group Policy' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.1 (L2) Ensure 'Turn off access to the Store' is set to 'Enabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.2 (L1) Ensure 'Turn off downloading of print drivers over HTTP' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.6 (L2) Ensure 'Turn off printing over HTTP' is set to 'Enabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.7 (L2) Ensure 'Turn off Registration if URL connection is referring to Microsoft.com' is set to 'Enabled'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.8 (L2) Ensure 'Turn off Search Companion content file updates' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.9 (L2) Ensure 'Turn off the `"Order Prints`" picture task' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.10 (L2) Ensure 'Turn off the `"Publish to Web`" task for files and folders' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.12 (L2) Ensure 'Turn off Windows Customer Experience Improvement Program' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.20.1.13 (L2) Ensure 'Turn off Windows Error Reporting' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.23.1 (L2) Ensure 'Support device authentication using certificate' is set to 'Enabled: Automatic'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.26.1 (L1) Ensure 'Block user from showing account details on sign-in' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.26.2 (L1) Ensure 'Do not display network selection UI' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.26.3 (L1) Ensure 'Do not enumerate connected users on domain-joined computers' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.26.4 (L1) Ensure 'Enumerate local users on domain-joined computers' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.26.5 (L1) Ensure 'Turn off app notifications on the lock screen' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.26.6 (L1) Ensure 'Turn off picture password sign-in' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.26.7 (L1) Ensure 'Turn on convenience PIN sign-in' is set to 'Disabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.29.5.2 (L1) Ensure 'Require a password when a computer wakes (plugged in)' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.30.1 (L1) Ensure 'Configure Offer Remote Assistance' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.30.2 (L1) Ensure 'Configure Solicited Remote Assistance' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.31.1 (L1) Ensure 'Enable RPC Endpoint Mapper Client Authentication' is set to 'Enabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.31.2 (L1) Ensure 'Restrict Unauthenticated RPC clients' is set to 'Enabled: Authenticated'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.44.1.1 (L2) Ensure 'Enable Windows NTP Client' is set to 'Enabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "4.10.44.1.2 (L2) Ensure 'Enable Windows NTP Server' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.3.1 (L1) Ensure 'Allow Microsoft accounts to be optional' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.6.1 (L1) Ensure 'Disallow Autoplay for non-volume devices' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.6.2 (L1) Ensure 'Set the default behavior for AutoRun' is set to 'Enabled: Do not execute any autorun commands'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.6.3 (L1) Ensure 'Turn off Autoplay' is set to 'Enabled: All drives'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.8.1 (L1) Ensure 'Do not display the password reveal button' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.8.3 (L1) Ensure 'Prevent the use of security questions for local accounts' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.15.1.2 (L1) Ensure 'Application: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater'(Automated)"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.15.2.1 (L1) Ensure 'Security: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled'(Automated)"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.15.3.1 (L1) Ensure 'Setup: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled'(Automated)"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.15.3.2 (L1) Ensure 'Setup: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater'"
          "description" = "Implemented. 100MB"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.15.4.1 (L1) Ensure 'System: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.15.4.2 (L1) Ensure 'System: Specify the maximum log file size (KB)' is set to 'Enabled: 32,768 or greater'"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.18.3 (L1) Ensure 'Turn off heap termination on corruption' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.18.4 (L1) Ensure 'Turn off shell protocol protected mode' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.27.1 (L1) Ensure 'Block all consumer Microsoft account user authentication' is set to 'Enabled''"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.28.3.1 (L1) Ensure 'Configure local setting override for reporting to Microsoft MAPS' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.28.3.2 (L2) Ensure 'Join Microsoft MAPS' is set to 'Disabled'"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.28.10.1 (L2) Ensure 'Configure Watson events' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.35.1 (L2) Ensure 'Turn off Push To Install service' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.3.2 (L1) Ensure 'Do not allow passwords to be saved' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.4.3.1 (L2) Ensure 'Do not allow COM port redirection' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.4.3.2 (L1) Ensure 'Do not allow drive redirection' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.4.3.3 (L2) Ensure 'Do not allow LPT port redirection' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.4.3.4 (L2) Ensure 'Do not allow supported Plug and Play device redirection' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.4.9.2 (L1) Ensure 'Require secure RPC communication' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.4.9.5 (L1) Ensure 'Set client connection encryption level' is set to 'Enabled: High Level'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.4.10.2 (L2) Ensure 'Set time limit for disconnected sessions' is set to 'Enabled: 1 minute'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.36.4.11.1 (L1) Ensure 'Do not delete temp folders upon exit' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.37.1 (L1) Ensure 'Prevent downloading of enclosures' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.42.1 (L1) Ensure 'Turn off the offer to update to the latest version of Windows' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.42.2 (L2) Ensure 'Turn off the Store application' is set to 'Enabled'"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.49.1 (L2) Ensure 'Prevent Internet Explorer security prompt for Windows Installer scripts' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.52.2.1 (L2) Ensure 'Prevent Codec Download (User)' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.55.1.1 (L1) Ensure 'Allow Basic authentication' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.55.1.1 (L1) Ensure 'Allow Basic authentication' is set to 'Disabled' (Server)"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.55.1.2 (L1) Ensure 'Allow unencrypted traffic' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.55.2.4 (L1) Ensure 'Disallow WinRM from storing RunAs credentials' is set to 'Enabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingString"
          "displayName" = "4.11.56.1 (L2) Ensure 'Allow Remote Shell Access' is set to 'Disabled'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.1 (L1) Ensure 'Account Logon Audit Credential Validation' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.2 (L1) Ensure 'Account Logon Logoff Audit Account Lockout' is set to include 'Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.3 (L1) Ensure 'Account Logon Logoff Audit Group Membership' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.4 (L1) Ensure 'Account Logon Logoff Audit Logoff' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.5 (L1) Ensure 'Account Logon Logoff Audit Logon' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.6 (L1) Ensure 'Account Management Audit Application Group Management' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.7 (L1) Ensure 'Audit Authentication Policy Change' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.8 (L1) Ensure 'Audit Authorization Policy Change' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.10 (L1) Ensure 'Audit File Share Access' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.11 (L1) Ensure 'Audit Other Logon Logoff Events' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.12 (L1) Ensure 'Audit Security Group Management' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.13 (L1) Ensure 'Audit Security System Extension' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.14 (L1) Ensure 'Audit Special Logon' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.15 (L1) Ensure 'Audit User Account Management' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.16 (L1) Ensure 'Detailed Tracking Audit PNP Activity' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.17 (L1) Ensure 'Detailed Tracking Audit Process Creation' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.18 (L1) Ensure 'Object Access Audit Detailed File Share' is set to include 'Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.19 (L1) Ensure 'Object Access Audit Other Object Access Events' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.20 (L1) Ensure 'Object Access Audit Removable Storage' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.21 (L1) Ensure 'Policy Change Audit MPSSVC Rule Level Policy Change' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.22 (L1) Ensure 'Policy Change Audit Other Policy Change Events' is set to include 'Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.23 (L1) Ensure 'Privilege Use Audit Sensitive Privilege Use' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.25 (L1) Ensure 'System Audit Other System Events' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.26 (L1) Ensure 'System Audit Security State Change' is set to include 'Success'"
          "description" = "Implemented"
    ...
    @{
          "@odata.type" = "#microsoft.graph.omaSettingInteger"
          "displayName" = "6.27 (L1) Ensure 'System Audit System Integrity' is set to 'Success and Failure'"
          "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "12.1 (L2) Ensure 'Allow Camera' is set to 'Not allowed'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "22.2 (L1) Ensure 'Allow Email Scanning' is set to 'Allowed'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "22.3 (L1) Ensure 'Allow Full Scan Removable Drive Scanning' is set to 'Allowed'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "22.4 (L1) Ensure 'Allow Realtime Monitoring' is set to 'Allowed'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "22.5 (L1) Ensure 'Allow scanning of all downloaded files and attachments' is set to 'Allowed'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "22.6 (L1) Ensure 'Allow Script Scanning' is set to 'Allowed'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "22.26 (L1) Ensure 'Enable Network Protection' is set to 'Enabled (block mode)'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "23.1 (L1) Ensure 'DO Download Mode' is NOT set to 'HTTP blended with Internet Peering'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "24.1 (L1) Ensure 'Configure System Guard Launch' is set to 'Unmanaged Enables Secure Launch if supported by hardware'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "24.2 (L1) Ensure 'Credential Guard' is set to 'Enabled with UEFI lock'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "24.3 (L1) Ensure 'Enable Virtualization Based Security' is set to 'Enable virtualization based security'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "24.4 (L1) Ensure 'Require Platform Security Features' is set to 'Turns on VBS with Secure Boot' or higher"
        "description" = "Implemented. Caution. Requires Intel VTX, AMDV, secure boot and compatible drivers."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "26.4 (L1) Ensure 'Device Password Expiration' is set to '365 or fewer days, but not 0'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "26.5 (L1) Ensure 'Device Password History' is set to '24 or more password(s)''"
        "description" = "Opposed."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "26.9 (L1) Ensure 'Minimum Password Age' is set to '1 or more day(s)'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "34.1 (L1) Ensure 'Allow Cortana' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "34.2 (L1) Ensure 'Allow Spotlight Collection (User)' is set to '0'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "34.3 (L2) Ensure 'Allow Windows Spotlight (User)' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "34.4 (L1) Ensure 'Disable Consumer Account State Content' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "34.5 (L1) Ensure 'Do not show feedback notifications' is set to 'Feedback notifications are disabled'"
        "description" = "Implemented"
    ...
    @{
        ...
        "displayName" = "38.1 (L1) Ensure 'Enable Domain Network Firewall' is set to 'True'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "38.2 (L1) Ensure 'Enable Domain Network Firewall: Default Inbound Action for Domain Profile' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.3 (L1) Ensure 'Enable Domain Network Firewall: Disable Inbound Notifications' is set to 'True'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.4 (L1) Ensure 'Enable Domain Network Firewall: Enable Log Dropped Packets' is set to 'Yes: Enable Logging Of Dropped Packets'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.5 (L1) Ensure 'Enable Domain Network Firewall: Enable Log Success Connections' is set to 'Enable Logging Of Successful Connections'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "38.6 (L1) Ensure 'Enable Domain Network Firewall: Log File Path' is set to '%SystemRoot%\System32\logfiles\firewall\domainfw.log'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "38.7 (L1) Ensure 'Enable Domain Network Firewall: Log Max File Size' is set to '16,384 KB or greater'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.8 (L1) Ensure 'Enable Private Network Firewall' is set to 'True'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "38.9 (L1) Ensure 'Enable Private Network Firewall: Default Inbound Action for Private Profile' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.10 (L1) Ensure 'Enable Private Network Firewall: Disable Inbound Notifications' is set to 'True'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.11 (L1) Ensure 'Enable Private Network Firewall: Enable Log Success Connections' is set to 'Enable Logging Of Successful Connections'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.12 (L1) Ensure 'Enable Private Network Firewall: Enable Log Dropped Packets' is set to 'Yes: Enable Logging Of Dropped Packets'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "38.13 (L1) Ensure 'Enable Private Network Firewall: Log File Path' is set to '%SystemRoot%\System32\logfiles\firewall\Privatefw.log'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "38.14 (L1) Ensure 'Enable Private Network Firewall: Log Max File Size' is set to '16,384 KB or greater'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.15 (L1) Ensure 'Enable Public Network Firewall' is set to 'True'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.16 (L1) Ensure 'Enable Public Network Firewall: Allow Local Ipsec Policy Merge' is set to 'False'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.17 (L1) Ensure 'Enable Public Network Firewall: Allow Local Policy Merge' is set to 'False'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "38.18 (L1) Ensure 'Enable Public Network Firewall: Default Inbound Action for Public Profile' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.19 (L1) Ensure 'Enable Public Network Firewall: Disable Inbound Notifications' is set to 'True'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.20 (L1) Ensure 'Enable Public Network Firewall: Enable Log Dropped Packets' is set to 'Yes: Enable Logging Of Dropped Packets'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingBoolean"
        "displayName" = "38.21 (L1) Ensure 'Enable Public Network Firewall: Enable Log Success Connections' is set to 'Enable Logging Of Successful Connections'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "38.22 (L1) Ensure 'Enable Public Network Firewall: Log File Path' is set to '%SystemRoot%\System32\logfiles\firewall\publicfw.log'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "38.23 (L1) Ensure 'Enable Public Network Firewall: Log Max File Size' is set to '16,384 KB or greater'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "45.1 (L1) Ensure 'Accounts: Block Microsoft accounts' is set to 'Users can't add or log on with Microsoft accounts'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "45.6 (L2) Ensure 'Devices: Prevent users from installing printer drivers when connecting to shared printers' is set to 'Enable'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "45.19 (L1) Ensure 'Network access: Do not allow anonymous enumeration of SAM accounts and shares' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "45.31 (L1) Ensure 'User Account Control: Detect application installations and prompt for elevation' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "45.34 (L1) Ensure 'User Account Control: Switch to the secure desktop when prompting for elevation' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "47.1 (L2) Ensure 'Disallow KMS Client Online AVS Validation' is set to 'Allow'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "48.7 (L1) Ensure 'Require Private Store Only' is set to 'Only Private store is enabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.1 (L1) Ensure 'Accounts: Enable Guest account status' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "49.3 (L1) Configure 'Accounts: Rename administrator account'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "49.4 (L1) Configure 'Accounts: Rename guest account'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.6 (L1) Ensure 'Interactive logon: Do not display last signed-in' is set to 'Enabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "49.9 (L1) Configure 'Interactive logon: Message text for users attempting to log on'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "49.10 (L1) Configure 'Interactive logon: Message title for users attempting to log on'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.13 (L1) Ensure 'Microsoft network client: Digitally sign communications (if server agrees)' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.15 (L1) Ensure 'Microsoft network server: Digitally sign communications (always)' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.16 (L1) Ensure 'Microsoft network server: Digitally sign communications (if client agrees)' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.17 (L1) Ensure 'Network access: Do not allow anonymous enumeration of SAM accounts' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.19 (L1) Ensure 'Network access: Restrict anonymous access to Named Pipes and Shares' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "49.20 (L1) Ensure 'Network access: Restrict clients allowed to make remote calls to SAM' is set to 'Administrators: Remote Access: Allow'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.21 (L1) Ensure 'Network security: Allow Local System to use computer identity for NTLM' is set to 'Allow'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.22 (L1) Ensure 'Network Security: Allow PKU2U authentication requests' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.24 (L1) Ensure 'Network security: LAN Manager authentication level' is set to 'Send LM and NTLMv2 responses only. Refuse LM and NTLM'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.25 (L1) Ensure 'Network security: Minimum session security for NTLM SSP based (including secure RPC) clients' is set to 'Require NTLM and 128-bit encryption'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.26 (L1) Ensure 'Network security: Minimum session security for NTLM SSP based (including secure RPC) servers' is set to 'Require NTLM and 128-bit encryption'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.27 (L1) Ensure 'Network security: Restrict NTLM: Audit Incoming NTLM Traffic' is set to 'Enable auditing for all accounts'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.28 (L1) Ensure 'User Account Control: Behavior of the elevation prompt for administrators' is set to 'Prompt for consent on the secure desktop' or higher"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.29 (L1) Ensure 'User Account Control: Behavior of the elevation prompt for standard users' is set to 'Automatically deny elevation requests'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.32 (L1) Ensure 'User Account Control: Use Admin Approval Mode' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.34 (L1) Ensure 'User Account Control: Run all administrators in Admin Approval Mode' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "49.35 (L1) Ensure 'User Account Control: Virtualize file and registry write failures to per-user locations' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "55.5 (L2) Ensure 'Disable Store Originated Apps' is set to 'Enabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "55.6 (L1) Ensure 'MSI Allow user control over installs' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "55.7 (L1) Ensure 'MSI Always install with elevated privileges' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "55.8 (L1) Ensure 'MSI Always install with elevated privileges (User)' is set to 'Disabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "68.2 (L1) Ensure 'Allow Input Personalization' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "68.3 (L2) Ensure 'Disable Advertising ID' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "72.1 (L2) Ensure 'Allow Cloud Search' is set to 'Not allowed'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "72.2 (L1) Ensure 'Allow Indexing Encrypted Stores Or Items' is set to 'Block'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "72.3 (L1) Ensure 'Allow Search To Use Location' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "72.4 (L2) Ensure 'Allow search highlights' is set to '0'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "74.1 (L2) Ensure 'Allow Online Tips' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "76.1.2 (L1) Ensure 'Notify Password Reuse' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "76.1.3 (L1) Ensure 'Notify Unsafe App' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "76.1.4 (L1) Ensure 'Service Enabled' is set to 'Enabled'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "80.1 (L2) Ensure 'Allow Font Providers' is set to 'Not allowed'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "80.1 (L2) Ensure 'Allow suggested apps in Windows Ink Workspace' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "80.3 (L1) Ensure 'Allow Telemetry' is set to 'Basic'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "80.5 (L2) Ensure 'Disable One Drive File Sync' is set to 'Sync Disabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "80.6 (L1) Ensure 'Enable OneSettings Auditing' is set to 'Enabled'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "80.7 (L1) Ensure 'Limit Diagnostic Log Collection' is set to 'Enabled'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "80.8 (L1) Ensure 'Limit Dump Collection' is set to 'Enabled'"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "97.3 (L1) Ensure 'Minimum PIN Length' is set to '6 more character(s)'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "103.1 (L1) Ensure 'Allow Auto Update' is set to 'Enabled'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "103.2 (L1) Ensure 'Defer Feature Updates Period in Days' is set to 'Enabled: 180 or more days'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "103.3 (L1) Ensure 'Defer Quality Updates Period (Days)' is set to 'Enabled: 0 days'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "103.4 (L1) Ensure 'Manage preview builds' is set to 'Disable Preview builds'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "103.5 (L1) Ensure 'Scheduled Install Day' is set to 'Every day'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "103.6 (L1) Ensure 'Block 'Pause Updates' ability' is set to 'Block'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "105.1 (L1) LAPS: Ensure 'Backup Directory' is set to 'Backup the password to Azure AD only'"
        "description" = "Implemented"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "105.2 (L1) LAPS: Ensure 'Password Age Days' is set to 'Configured: 30 or fewer'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "105.4 (L1) LAPS: Ensure 'Password Length' is set to 'Configured: 15 or more'"
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "105.5 (L1) LAPS: Ensure 'Post-authentication actions' is set to 'Reset the password and logoff the managed account' or higher"
        "description" = "Implemented."
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingInteger"
        "displayName" = "105.6 (L1) LAPS: Ensure 'Post Authentication Reset Delay' is set to 'Configured: 8 or fewer hours, but not 0'"

...
$params = @{
  ...
  description = "This is the primary CIS Baseline Policy implemented using OMAURI."
  displayName = "CIS Baseline Microsoft Intune for Windows 11 v3.0.1 (Primary)"
  version = 1
  omaSettings = @(
    @{
    ...
    @{
        "@odata.type" = "#microsoft.graph.omaSettingString"
        "displayName" = "3.10.09.6 (L1) Ensure 'Turn off background refresh of Group Policy' is set to 'Disabled' (Automated)"
        "description" = "Implemented"
    ...
    @{
          ...
          "description" = "Opposed. The rationalization for this is that an attacker may access using saved username/password, but that has already been disabled which make this setting just annoying when remoting."
    ...
    @{
          ...
          "description" = "Opposed. When using Hello Pin, NLA won't work"
